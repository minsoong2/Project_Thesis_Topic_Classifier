...
# - 수정
collection = db['my_collection_selected_data_3']
...
with open("new_x_labels_with_y_3.txt", 'w') as new_file:
    new_file.write(file_content)

# 텍스트 파일에서 국가과학기술표준분류체계와 개수 가져오기
with open('new_x_labels_with_y_3.txt', 'r') as file:
...
print(paper_count)
save_dictionary(paper_count, "new_x_labels_with_y_3.txt")
f.close()
